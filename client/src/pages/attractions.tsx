          ...
          <div className="mt-16 bg-[#6A8EAE] bg-opacity-10 rounded-lg p-8 md:p-12">
            <div className="grid md:grid-cols-2 gap-8 items-center">
              <div>
                ...
                <p className="mb-6">
                  Experience the vibrant cultural life of Gogana through our
                  seasonal celebrations and traditional festivals that highlight
                ...
                <ul className="space-y-3">
                  <li className="flex items-start">
                    ...
                    <div>
                      <span className="font-semibold">Phool Dei (March)</span> -
                  ...
                  <li className="flex items-start">
                    <i className="fas fa-calendar-alt mt-1 mr-3 text-[#2C5F2D]"></i>
                    <div>
                      <span className="font-semibold">Harela (July)</span> -
                  ...
                  <li className="flex items-start">
                    <i className="fas fa-calendar-alt mt-1 mr-3 text-[#2C5F2D]"></i>
                    <div>
                      <span className="font-semibold">Khatarua (October)</span>{" "}
                  ...
                  <li className="flex items-start">
                    ...
                    <div>
                      ...
                      - Winter gathering with cultural performances
                    </div>
                  </li>
                </ul>
              </div>
