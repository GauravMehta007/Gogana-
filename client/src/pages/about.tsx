          ...
          <div className="grid md:grid-cols-2 gap-12 items-center">
            <div>
              <h3 className="font-['Playfair_Display'] text-2xl font-semibold mb-4">
                A Village with Rich Heritage
              </h3>
              <p className="mb-4">
                Nestled in the picturesque landscapes of Uttarakhand's
                Pithoragarh district near Gurna, Gogana is a tranquil village
                that embodies the authentic Himalayan way of life. Our community
                preserves centuries-old traditions while embracing the natural
                beauty that surrounds us.
              </p>
              <p className="mb-4">
                Gogana's history dates back generations, with inhabitants who
                have lived in harmony with nature, developing unique cultural
                practices, architecture, and agricultural techniques adapted to
                mountain living.
              </p>

              <h3 className="font-['Playfair_Display'] text-2xl font-semibold mb-4 mt-8">
                Cultural Tapestry
              </h3>
              <p>
                Our village celebrates seasonal festivals that mark agricultural
                cycles and religious observances. The community maintains
                traditional crafts including wool weaving, wood carving, and
                unique cuisine that uses local ingredients from our mountainous
                terrain.
              </p>
            </div>
      ...
      <section className="py-20 bg-[#F4F1DE]">
        <div className="container mx-auto px-4">
          ...
          <div className="grid md:grid-cols-2 gap-12 items-center">
            ...
            <div>
              <h3 className="font-['Playfair_Display'] text-2xl font-semibold mb-6">
              ...
              <div className="space-y-6">
                <div className="flex items-start">
                  ...
                  <div>
                    ...
                    <p>
                      Spring flower festival celebrating the arrival of new
                      blossoms. Children collect flowers and offer them at
                      doorsteps as a symbol of prosperity.
                    </p>
                  </div>
                </div>
                ...
                <div className="flex items-start">
                  ...
                  <div>
                    ...
                    <p>
                      Agricultural festival marking monsoon planting season.
                      Seeds are sown in small pots and worshipped as they
                      sprout, symbolizing the bond with nature.
                    </p>
                  </div>
                </div>
                ...
                <div className="flex items-start">
                  ...
                  <div>
                    ...
                    <p>
                      Harvest celebration with folk dances and traditional
                      music. The entire village gathers for communal meals
                      featuring the new harvest.
                    </p>
                  </div>
                </div>
                ...
                <div className="flex items-start">
                  ...
                  <div>
                    <h4 className="font-semibold text-lg mb-1">
                      Uttarayani Fair (January)
                    </h4>
                    <p>
                      Winter gathering with cultural performances, celebrating
                      the northward journey of the sun with traditional rituals
        ...
        <div className="container mx-auto px-4">
          ...
          <div className="grid md:grid-cols-3 gap-8">
            <div className="bg-[#F4F1DE] rounded-lg shadow-lg p-8">
              ...
              <p>
                The village maintains strong community bonds through traditional
                social structures, where village elders provide guidance and
                families support each other through cooperative work and shared
                celebrations.
              </p>
            </div>
            ...
            <div className="bg-[#F4F1DE] rounded-lg shadow-lg p-8">
              ...
              <p>
                For generations, the people of Gogana have practiced sustainable
                agriculture, water conservation, and resource management,
                adapting traditional knowledge to preserve the delicate mountain
                ecosystem.
              </p>
            </div>
            ...
            <div className="bg-[#F4F1DE] rounded-lg shadow-lg p-8">
              ...
              <p>
                Known for their warmth and generosity, Gogana's residents
                welcome visitors with traditional hospitality, sharing their
                homes, meals, and stories with those who come to experience our
