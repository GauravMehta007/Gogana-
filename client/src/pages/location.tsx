        ...
        <div className="container mx-auto px-4">
          <div className="text-center mb-16">
            ...
            <p className="max-w-2xl mx-auto mt-6">
              Gogana village is located in Pithoragarh district of Uttarakhand,
              near Gurna. Here's how you can reach us.
            </p>
          </div>
          ...
          <div className="grid md:grid-cols-2 gap-8 items-stretch">
            <div className="bg-white rounded-lg shadow-lg p-6 md:p-8">
              ...
              <div className="space-y-6">
                <div className="flex items-start">
                  ...
                  <div>
                    ...
                    <p>
                      ...
                      approximately 240 km from Gogana. From there, hire a taxi
                      or take a bus to Pithoragarh, then local transport to
                      Gogana.
                    </p>
                  </div>
                </div>
                ...
                <div className="flex items-start">
                  ...
                  <div>
                    ...
                    <p>
                      Kathgodam Railway Station is the nearest railhead, about
                      180 km from Gogana. Regular bus and taxi services are
                      available from Kathgodam to Pithoragarh.
                    </p>
                  </div>
                </div>
                ...
                <div className="flex items-start">
                  ...
                  <div>
                    ...
                    <p>
                      Gogana is connected by road to major cities in
                      Uttarakhand. Regular buses operate from Dehradun,
                      Haldwani, and Almora to Pithoragarh. From Pithoragarh,
                      local transport is available to Gogana.
                    </p>
                  </div>
                </div>
                ...
                <div className="flex items-start">
                  ...
                  <div>
                    ...
                    <p>
                      From Pithoragarh town, shared jeeps and taxis can take you
                      to Gurna, from where Gogana is a short 2 km journey. Local
                      guides can assist with arrangements.
                    </p>
                  </div>
                </div>
              </div>
              ...
              <div className="mt-8 border-t pt-6">
                ...
                <p>
                  The ideal time to visit Gogana is from March to June and
                  September to November when the weather is pleasant and views
                  are clear. Monsoon (July-August) brings lush greenery but may
                  pose travel challenges.
                </p>
              </div>
            </div>
          ...
          <div className="grid md:grid-cols-3 gap-8">
            <div className="bg-[#F4F1DE] rounded-lg overflow-hidden shadow-lg transition-transform duration-300 hover:shadow-xl">
              ...
              <div className="p-6">
                ...
                <p className="mb-4">
                  Experience authentic local hospitality by staying with village
                  families. Enjoy home-cooked Kumaoni meals and learn about
                  daily village life directly from your hosts.
                </p>
            ...
            <div className="bg-[#F4F1DE] rounded-lg overflow-hidden shadow-lg transition-transform duration-300 hover:shadow-xl">
              ...
              <div className="p-6">
                ...
                <p className="mb-4">
                  Stay in environmentally-friendly cottages built with local
                  materials. These accommodations offer modern comforts while
                  maintaining traditional architectural elements.
                </p>
                <div className="flex items-center text-sm text-gray-600">
                  <i className="fas fa-rupee-sign mr-2"></i>
            ...
            <div className="bg-[#F4F1DE] rounded-lg overflow-hidden shadow-lg transition-transform duration-300 hover:shadow-xl">
              ...
              <div className="p-6">
                ...
                <p className="mb-4">
                  For adventure enthusiasts, camping options are available in
                  designated areas with basic facilities. Experience the night
                  sky like never before under the clear mountain stars.
                </p>
                <div className="flex items-center text-sm text-gray-600">
                  <i className="fas fa-rupee-sign mr-2"></i>
